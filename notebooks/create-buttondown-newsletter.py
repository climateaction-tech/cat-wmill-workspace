...
def _(BUTTONDOWN_API_KEY):
    ...
    response
    return headers, httpx, response, url
...
def _(get_next_sunday, newsletters, re):
    ...
    return (new_issue_title,)


@app.cell
def _(mo):
    mo.md(r"""## OK, now we create our new newsletter, using the API, and `new_issue_title`, and fetching the most recently created newsletter file locally.""")
    return


@app.cell
def _(headers, httpx, latest_newsletter_text, new_issue_title, url):
    newsletter_text = ""
